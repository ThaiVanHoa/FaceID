...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        img3 = img3.resize((1530, 790), PIL.Image.NEAREST)
        ...
        if(value_from_home=="0" or value_from_home==None):
            conn = mysql.connector.connect(host='localhost', user='root', password='',
                                           database='face_recognizer', port='3307')
        ...
        img_btn1 = img_btn1.resize((350, 45), PIL.Image.NEAREST)
        ...
        img_btn2 = img_btn2.resize((350, 45), PIL.Image.NEAREST)
        ...
        self.img_right = self.img_right.resize((190, 190), PIL.Image.NEAREST)
    ...
    def face_recog(self):
            ...
            def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
                ...
                for(x,y,w,h) in features:
                    ...
                    conn = mysql.connector.connect(host='localhost', user='root', password='', database='face_recognizer', port='3307')
                    my_cursor = conn.cursor()
